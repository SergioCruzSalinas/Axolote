    ...
    <div class="max-w-6xl mx-auto">
      ...
      <div class="text-center mb-16">
        ...
        <p class="text-gray-600 mt-4 max-w-2xl mx-auto">
          Impulsamos a pequeñas empresas a crecer en el mundo digital de forma simple y eficiente.
        </p>
      </div>
      ...
      <div class="grid md:grid-cols-3 gap-8">
        ...
        <div class="bg-white p-8 rounded-2xl shadow-sm hover:shadow-lg transition">
          <h2 class="text-xl font-semibold text-[#172554] mb-4">
            Descripción
          </h2>
        ...
        <div class="bg-white p-8 rounded-2xl shadow-sm hover:shadow-lg transition border-t-4 border-[#2563EB]">
          <h2 class="text-xl font-semibold text-[#172554] mb-4">
            Misión
          </h2>
          <p class="text-gray-600 leading-relaxed">
